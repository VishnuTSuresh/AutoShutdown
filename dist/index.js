...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(122).equal(queue.length, 0)
  })
}
...
var Stream = __webpack_require__(125).Stream
...
var open = __webpack_require__(114);
var moment = __webpack_require__(0);
var jsonfile = __webpack_require__(113);
var TimeTool_1 = __webpack_require__(115);
var settings = jsonfile.readFileSync("settings.json");
var from = settings.from;
var to = settings.to;
var app_start_time = moment();
var timetool = new TimeTool_1.TimeTool(from.hour, from.minute, to.hour, to.minute);
function tick() {
    var now_time = moment();
