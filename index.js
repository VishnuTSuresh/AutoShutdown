...
/* WEBPACK VAR INJECTION */(function(__dirname) {var exec = __webpack_require__(2).exec
  , path = __webpack_require__(123)
  ;
...
var fs = __webpack_require__(1)
var polyfills = __webpack_require__(118)
var legacy = __webpack_require__(117)
var queue = []
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(121).equal(queue.length, 0)
  })
}
...
var child_process_1 = __webpack_require__(2);
var open = __webpack_require__(115);
var moment = __webpack_require__(0);
var jsonfile = __webpack_require__(113);
var _ = __webpack_require__(114);
var _time = _.memoize(function (hour, minute) {
...
var app_start_time = moment();
function tick() {
    var now_time = moment();
    if (now_time.diff(app_start_time, "minutes") >= 1) {
        var shutdown_time = time(from.hour, from.minute);
        var wakeup_time = time(to.hour, to.minute);
        var popup_time = shutdown_time.clone().subtract(15, "minutes");
        ...
        if (shutdown) {
            child_process_1.spawn("shutdown", ["-s"]);
        }
    }
}
tick();
